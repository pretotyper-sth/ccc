  ...
  return (
    <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: BG, display: "flex", flexDirection: "column" }}>
      ...
      <header style={{
        ...
        <Link href="/" style={{ fontSize: 12, color: TEXT_SEC, marginTop: 2 }}>🇰🇷 한국어</Link>
      </header>
          ...
          <div onClick={(e) => e.stopPropagation()} style={{
            ...
            {modalTab === "signup" ? (
              <>
                ...
                <Link href="/signup/jp" style={{ display: "block", padding: "15px", background: "#111", color: "#fff", borderRadius: 12, fontSize: 14, fontWeight: 800, marginBottom: 10 }}>
                  無料で始める
                </Link>
              ...
              <>
                ...
                <button onClick={() => {
                  ...
                  if (!stored) { setLoginErr("登録済みのアカウントが見つかりません。まずご登録ください。"); return; }
